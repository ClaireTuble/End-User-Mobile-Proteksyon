...
export const EmergencyCallScreen: React.FC = () => {
  ...
  const handleQuickEmergency = () => {
    Alert.alert(
      ...
      [
        { text: 'Fire Emergency', onPress: () => handleEmergencyCall(emergencyContacts[1]) },
        { text: 'Medical Emergency', onPress: () => handleEmergencyCall(emergencyContacts[2]) },
        { text: 'Police Emergency', onPress: () => handleEmergencyCall(emergencyContacts[3]) },
